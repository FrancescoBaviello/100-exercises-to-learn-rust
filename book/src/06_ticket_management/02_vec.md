...
- The **length** of the vector, _i._e. how many elements are in the vector.
- The **capacity** of the vector, _i._e. the number of elements that can fit in the space reserved on the heap.
