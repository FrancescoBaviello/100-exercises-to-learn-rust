...
In fact, you've already seen traits in action throughout the previous chapter, _e.g. `.into()` invocations as well
...
- Operator traits (_e.g. `Add`, `Sub`, `PartialEq`, etc.)
...
from the previous chapter—_e.g. what is `"A title"`, exactly? Time to learn more about slices too!
